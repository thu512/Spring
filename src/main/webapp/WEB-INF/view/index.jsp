...
<body class="theme-red">
		...
		<aside id="leftsidebar" class="sidebar">
			...
			<div class="user-info">
				...
				<div class="info-container">
					...
					<div class="email"><sec:authentication property="principal.username" />@gsshop.com</div>
				...
				<ul class="list">
					...
					<li class="active"><a href="javascript:void(0);"
						...
						<ul class="ml-menu">
							...
							<li><a href="/getItemList.do">상품 리스트</a></li>
					...
					<li><a href="javascript:void(0);" class="menu-toggle"> <i
						...
						<ul class="ml-menu">
							<li><a href="/useCpu.do">cpu사용량</a></li>
							<li><a href="/chart.do">통계차트</a></li></li>
				</ul>
				</li>
	...
	<script
		src="/AdminBSBMaterialDesign-master/plugins/jquery-datatable/jquery.dataTables.js"></script>
	<script
		src="/AdminBSBMaterialDesign-master/plugins/jquery-datatable/skin/bootstrap/js/dataTables.bootstrap.js"></script>
	<script
		src="/AdminBSBMaterialDesign-master/plugins/jquery-datatable/extensions/export/dataTables.buttons.min.js"></script>
	<script
		src="/AdminBSBMaterialDesign-master/plugins/jquery-datatable/extensions/export/buttons.flash.min.js"></script>
	<script
		src="/AdminBSBMaterialDesign-master/plugins/jquery-datatable/extensions/export/jszip.min.js"></script>
	<script
		src="/AdminBSBMaterialDesign-master/plugins/jquery-datatable/extensions/export/pdfmake.min.js"></script>
	<script
		src="/AdminBSBMaterialDesign-master/plugins/jquery-datatable/extensions/export/vfs_fonts.js"></script>
	<script
		src="/AdminBSBMaterialDesign-master/plugins/jquery-datatable/extensions/export/buttons.html5.min.js"></script>
	<script
		src="/AdminBSBMaterialDesign-master/plugins/jquery-datatable/extensions/export/buttons.print.min.js"></script>


	<!-- Morris Plugin Js
	<script src="/AdminBSBMaterialDesign-master/plugins/raphael/raphael.min.js"></script>
	<script src="/AdminBSBMaterialDesign-master/plugins/morrisjs/morris.js"></script>
 -->
	<!-- ChartJs -->
	<script src="/AdminBSBMaterialDesign-master/plugins/chartjs/Chart.bundle.js"></script>

	<!-- Flot Charts Plugin Js -->
	<script src="/AdminBSBMaterialDesign-master/plugins/flot-charts/jquery.flot.js"></script>
	<script src="/AdminBSBMaterialDesign-master/plugins/flot-charts/jquery.flot.resize.js"></script>
	<script src="/AdminBSBMaterialDesign-master/plugins/flot-charts/jquery.flot.pie.js"></script>
	<script src="/AdminBSBMaterialDesign-master/plugins/flot-charts/jquery.flot.categories.js"></script>
	<script src="/AdminBSBMaterialDesign-master/plugins/flot-charts/jquery.flot.time.js"></script>
	...
	<script
		src="/AdminBSBMaterialDesign-master/js/pages/tables/jquery-datatable.js"></script>
