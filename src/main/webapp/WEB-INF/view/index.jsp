...
<head>
    ...
    <!-- Morris Chart Css-->
    <link href="/AdminBSBMaterialDesign-master/plugins/morrisjs/morris.css" rel="stylesheet" />
...
<body class="theme-red">
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html"><img src="/AdminBSBMaterialDesign-master/img/GS_SHOP_logo.png" style="width:170px;height:60px;margin-top:-20px;"></a>
            </div>
    ...
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li class="active">
                        ...
                        <ul class="ml-menu" >
                            <li>
                                <a href="pages/tables/normal-tables.html">분류 리스트</a>
                            </li>
                            <li>
                                <a href="pages/tables/jquery-datatable.html">상품 리스트</a>
                            </li>
                            <li>
                                <a href="pages/tables/editable-table.html">네이버 쇼핑 리스트</a>
                            </li>
                        </ul>
                    </li>
            ...
            <div class="legal">
                <div class="copyright">
                    &copy; 2018 - 2019 <a href="javascript:void(0);">LCJ - Material Design</a>.
                </div>
                <div class="version">
                    <b>Version: </b> 1.0.0
                </div>
